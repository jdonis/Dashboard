...
namespace Dashboard.Controllers
{
    public class indicatorsController : Controller
    {
        ...
        {
            var indicators = db.indicators.Include(i => i.checklist).Include(i => i.indicatorgroup).Include(i => i.objective);
        ...
        public ActionResult Create([Bind(Include = "id,checklist_id,objective_id,indicatorgroup_id,code,mode,frequency,responsible,contact,inputtype")] indicator indicator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,checklist_id,objective_id,indicatorgroup_id,code,mode,frequency,responsible,contact,inputtype")] indicator indicator)
        {
            if (ModelState.IsValid)
            {
